...
namespace Webjet.Api.Services.Providers
{
    public class FilmworldService : IMovieProvider
    {
        ...
        public string ProviderName => ProviderNames.Filmworld;

        public FilmworldService(IHttpClientFactory httpFactory, IOptions<WebjetSettings> settings)
        {
            _http = httpFactory.CreateClient(ProviderNames.Filmworld);
        }
